  ...
  return (
    <>
      ...
      <div className="absolute top-4 right-4 flex gap-2">
        <button
          className="bg-gray-700 text-white px-3 py-1 rounded-lg shadow-md hover:bg-gray-800"
      ...
      {step === 1 && (
        <Dialog open>
          <DialogContent
            hideClose
            className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-6 rounded-lg shadow-xl"
          >
            <div className="text-center">
              ...
              <Button
                className="mt-4 bg-white text-blue-600 font-semibold px-6 py-2 rounded-lg shadow-md hover:bg-blue-100"
                onClick={() => setStep(2)}
              >
                {t("continue")}
              </Button>
        ...
        <Dialog open>
          <DialogContent className="bg-gray-800 text-white p-6 rounded-lg shadow-xl border border-gray-700">
            ...
            <div className="flex gap-4 justify-center mt-4">
              ...
              <Button
                className="bg-black text-white px-6 py-2 rounded-lg shadow-md hover:bg-gray-700"
                onClick={reloadPage}
              >
                {t("no")}
              </Button>
        ...
        <Dialog open>
          <DialogContent className="bg-gray-900 text-white p-4 md:p-6 rounded-lg shadow-xl border border-gray-700 animate-fadeIn max-w-[90vw] sm:max-w-md md:max-w-lg lg:max-w-xl max-h-[80vh] overflow-y-auto">
            ...
            <ul className="mt-2 space-y-2 md:space-y-3 text-sm md:text-base">
              <li className="flex items-center gap-2 flex-wrap">
                <span className="text-red-500">♨️</span> {t("grillHouse")}{" "}
              </li>
              <li className="flex items-center gap-2 flex-wrap">
              ...
              <li className="flex items-center gap-2 flex-wrap">
                <span className="text-cyan-400">🔥</span> {t("sauna")}{" "}
              </li>
              <li className="flex items-center gap-2 flex-wrap">
                <span className="text-gray-400">🛖</span> {t("smallTapchan")}
              </li>
              <li className="flex items-center gap-2 flex-wrap">
              ...
              <li className="flex items-center gap-2 flex-wrap">
                <span className="text-orange-400">VIP</span> {t("vipGazebosr")}
              </li>
              <li className="flex items-center gap-2 flex-wrap">
                <span className="text-orange-400">VIP</span> {t("vipGazebo")}
              </li>
              <li className="flex items-center gap-2 flex-wrap">
                <span className="text-pink-400">VIP</span> {t("vipCabin")}
              </li>
              <li className="flex items-center gap-2 flex-wrap">
                <span className="text-yellow-500">VIP</span> {t("vipHall")}
              </li>
              <li className="flex items-center gap-2 flex-wrap">
                <span className="text-purple-500">VIP</span>{" "}
                {t("vipTapchan")}{" "}
              </li>
            </ul>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-4 md:mt-4">
              <p className="text-[#8B5A2B] text-base md:text-lg mb-4 md:mb-6 italic text-center">
                {t("agree")}
              </p>
              <Button
                className="bg-green-500 text-white px-4 md:px-6 py-2 rounded-lg shadow-md hover:bg-green-600 transition-transform transform hover:scale-105 w-full sm:w-auto"
                onClick={() => setStep(4)}
              >
                {t("yes")}
              </Button>
              <Button
                className="bg-gray-700 text-white px-4 md:px-6 py-2 rounded-lg shadow-md hover:bg-gray-800 transition-transform transform hover:scale-105 w-full sm:w-auto"
                onClick={reloadPage}
              >
                {t("no")}
              </Button>
